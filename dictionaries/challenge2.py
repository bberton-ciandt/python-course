...
loc = 1
while True:
    available_exists = ", ".join(locations[loc]["exits"].keys())
    ...
    direction = input("Available exits are " + available_exists + " ").upper()
    print()

    if len(direction) > 1:  # more than one letter, check words
